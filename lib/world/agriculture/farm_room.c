...
query_long()
{
  ...
  if(planted)
  {
    ...
    if(time() >= done_time)
      ...
      buf += "are not ready to be harvested. ";
    if(disease && !(disease == ""))
    {
...
do_harvest()
{
  ...
  {
    case "corn":
      crop_file = ITEM_PATH + "corn_bundle.c";
      break;
   case "potatoes":
      crop_file = ITEM_PATH + "potato_bundle.c";
      break; 
   case "barley":
      crop_file = ITEM_PATH + "barley_bundle.c";
      break;
   case "cabbage":
      crop_file = ITEM_PATH + "cabbage_bundle.c";
      break;
   case "carrots":
      crop_file = ITEM_PATH + "carrot_bundle.c";
      break;
   case "green beans":
      crop_file = ITEM_PATH + "green_bean_bundle.c";
      break;
   case "tobacco":
      crop_file = ITEM_PATH + "tobacco_bundle.c";
      break;
   case "tomatoes":
      crop_file = ITEM_PATH + "tomato_bundle.c";
      break;
   case "wheat":
      crop_file = ITEM_PATH + "wheat_bundle.c";
      break;
   default:
  ...
  if(planted && time() >= done_time)
  {
    ...
    if(disease && disease != ""){
      ...
      pline("You harvest the "+crop_type+" and receive "+num+" bundles.\n");
