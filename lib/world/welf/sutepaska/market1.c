...
create_room ()
{
  ...
  + "er covered booths of the tanir folk. A street leads west from"
  + " here towards the Swan temple.");

  add_exit ("north", ROOM_PATH + "market3.c");
  add_exit ("west", ROOM_PATH + "spass2.c");
  add_exit ("east", ROOM_PATH + "market2.c");
