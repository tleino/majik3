...
create_room ()
{
  ...
  add_exit ("northeast", ROOM_PATH + "oforest11.c");
  add_exit ("north", ROOM_PATH + "iforest3.c");
  add_exit ("northwest", ROOM_PATH + "iforest1.c");
  add_exit ("west", ROOM_PATH + "iforest5.c");
  add_exit ("southwest", ROOM_PATH + "iforest8.c");
  add_exit ("south", ROOM_PATH + "iforest9.c");
  add_exit ("southeast", ROOM_PATH + "oforest18.c");
  add_exit ("east", ROOM_PATH + "oforest14.c");
