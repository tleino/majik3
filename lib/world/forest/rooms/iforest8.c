...
create_room ()
{
  ...
  + "d. There is a forest fire raging to the south and it is commi"
  + "ng this way.");

  add_exit ("northeast", ROOM_PATH + "iforest6.c");
  add_exit ("north", ROOM_PATH + "iforest5.c");
  add_exit ("northwest", ROOM_PATH + "iforest4.c");
  add_exit ("west", ROOM_PATH + "iforest7.c");
  add_exit ("southwest", ROOM_PATH + "oforest19.c");
  add_exit ("south", ROOM_PATH + "oforest21.c");
  add_exit ("southeast", ROOM_PATH + "oforest20.c");
  add_exit ("east", ROOM_PATH + "iforest9.c");
