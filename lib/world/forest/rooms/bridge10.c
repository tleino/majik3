...
create_room ()
{
  ...
  add_exit ("west", ROOM_PATH + "bridge9.c");
  add_exit ("northeast", ROOM_PATH + "bridge11.c");
  add_exit ("north", ROOM_PATH + "bridge16.c");
   ...
   else
{
   ...
   message("standard", capitalize(THIS->query_name()) + " climbs down the "
    "tree.\n", ENV(THIS), THIS);
   THIS->move_player ( ROOM_PATH + "oforest18.c");
   return 1;
}
}
