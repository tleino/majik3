...
create_room ()
{
  ...
  add_exit ("west", ROOM_PATH + "oforest17.c");
  add_exit ("south", ROOM_PATH + "oforest19.c");
  add_exit ("northeast", ROOM_PATH + "iforest5.c");
  add_exit ("southeast", ROOM_PATH + "oforest21.c");
  add_exit ("north", ROOM_PATH + "iforest4.c");
  add_exit ("east", ROOM_PATH + "iforest8.c");
  add_exit ("northwest", ROOM_PATH + "oforest13.c");
