...
create_room ()
{
  ...
  add_exit ("southwest", ROOM_PATH + "bridge11.c");
  add_exit ("northwest", ROOM_PATH + "bridge13.c");
...
do_climb(string what)
{
     ...
     if (what == "tree")
    {
     ...
     message("standard", capitalize(THIS->query_name()) + " climbs down the "
      "tree.\n", ENV(THIS), THIS);
     THIS->move_player ( ROOM_PATH + "oforest16.c");
     return 1;
  }
     if (what == "ladder")
  {
   ...
   THIS->move_player ( ROOM_PATH + "thouse2.c");
   return 1;
}
