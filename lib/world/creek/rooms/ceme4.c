...
create_room ()
{
  ...
  + "etary path leads east, west and south.");

  add_exit ("south", ROOM_PATH + "ceme5.c");
  add_exit ("east", ROOM_PATH + "ceme1.c");
  add_exit ("west", ROOM_PATH + "ceme6.c");
