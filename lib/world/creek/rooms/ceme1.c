...
create_room ()
{
  ...
  + "etary path leads west and to south you see a doorway to the t"
  + "emple.");

  add_exit ("south", ROOM_PATH + "gifts.c");
  add_exit ("west", ROOM_PATH + "ceme4.c");
