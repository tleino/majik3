...
create_room ()
{
  ...
  + "he animals away. Some memorial statues line the path. The cha"
  + "pel is in the south. The cemetary path leads east.");

  add_exit ("east", ROOM_PATH + "ceme4.c");
